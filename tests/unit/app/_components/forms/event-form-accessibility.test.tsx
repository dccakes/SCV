...
jest.mock('~/app/_components/hooks/forms/useEventFormActions', () => ({
  useEventFormActions: () => ({
    createEvent: jest.fn(),
...
jest.mock('~/app/_components/forms/event/date-input', () => {
  return function MockDateInput() {
    return <div>Date Input</div>
  }
})

jest.mock('~/app/_components/forms/event/time-selections', () => {

...
jest.mock('~/app/_components/contexts/edit-rsvp-settings-form-context', () => ({
...
jest.mock('~/app/_components/forms/question-form', () => {
  return function MockQuestionForm() {
    return <div>Question form</div>
  }
})

jest.mock('~/app/_components/forms/rsvp/general-questions-section', () => {
  return function MockGeneralQuestionsSection() {
    return <div>General questions</div>
  }
})

jest.mock('~/app/_components/forms/rsvp/no-questions.view', () => {
  return function MockNoQuestionsView() {
    return <div>No questions</div>
  }
})

jest.mock('~/app/_components/forms/rsvp/no-rsvp-view', () => {
  return function MockNoRsvpView() {
    return <div>No RSVP</div>
  }
})

jest.mock('~/app/_components/loaders', () => ({

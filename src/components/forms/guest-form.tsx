...
import EditFormButtons from '~/components/forms/guest/edit-buttons'
import GiftSection from '~/components/forms/guest/gift-section'
import { GuestNameForm } from '~/components/forms/guest/guest-names'
import {

...
**OSWP** is a modern, open-source wedding planning and RSVP management system built with the [T3 Stack](https://create.t3.gg/). This project aims to provide couples with a free, self-hosted alternative to commercial wedding planning platforms.

Built with `create-t3-app` ([repo](https://github.com/t3-oss/create-t3-app)), OSWP provides a complete wedding management experience that can be self-hosted or deployed to platforms like [Vercel](https://vercel.com/).

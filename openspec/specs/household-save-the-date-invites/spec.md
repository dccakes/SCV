# household-save-the-date-invites Specification

## Purpose
Provide household-specific public save-the-date invites that authenticate invited guests by browser cookie, show the wedding details, and collect updated household mailing/contact information without exposing RSVP or dashboard-only fields.
